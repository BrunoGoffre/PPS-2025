...
@Component({
  selector: 'app-grafico-torta-lindas',
  templateUrl: './grafico-torta-lindas.component.html',
  styleUrls: ['./grafico-torta-lindas.component.scss'],
  standalone: false
})
export class GraficoTortaLindasComponent implements OnInit {
