...
@Component({
  selector: 'app-grafico-barras-feas',
  templateUrl: './grafico-barras-feas.component.html',
  styleUrls: ['./grafico-barras-feas.component.scss'],
  standalone: false,
})
export class GraficoBarrasFeasComponent implements OnInit {
